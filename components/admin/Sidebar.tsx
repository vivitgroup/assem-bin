...
import {
  ...
  Settings, Video, LogOut, ExternalLink, X, Image as ImageIcon,
} from 'lucide-react';
...
const MENU = [
  ...
  { href: '/dashboard/banners',       label: 'البانرات',     icon: ImageIcon },
      ...
      <div className="p-5 border-b flex items-center justify-between" style={{ borderColor: 'rgba(255,255,255,0.07)' }}>
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl overflow-hidden bg-white/95 p-0.5 shadow-lg flex-shrink-0">
            <Image src="/logo.jpg" alt="بن صديق للأقمشة" width={40} height={40} className="w-full h-full object-contain" />
          </div>
          <div>
